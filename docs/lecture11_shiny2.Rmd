...
* Shiny **modules** create small namespaces where IDs can be safely defined  without conflicting with other IDs in the app (if you don't recall what a namespace is, see this [link](https://adv-r.hadley.nz/environments.html#namespaces)).
...
* Benefits are multiple: structure, documentation, tests, deployment, workflow, check, ...
